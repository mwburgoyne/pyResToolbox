...
///
/// # Returns
/// Tuple of (x_co2, y_co2, y_h2o, rho_gas, gas_z, converged, co2_sat) where:
...
/// * `co2_sat` - True when the CO2-rich phase settled on the liquid CO2 root
#[pyfunction]
pub fn co2_brine_solubility_rust(
    p_bar: f64,
    deg_c: f64,
    ppm: f64,
) -> PyResult<(f64, f64, f64, f64, f64, bool, bool)> {
