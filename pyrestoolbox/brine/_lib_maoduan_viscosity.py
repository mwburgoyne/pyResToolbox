...
`viscosity_route(route='mao_duan')` reproduces pre-3.7.3 results; it is NaCl
only and carries no pressure dependence on the salt ratio. Coefficients are
McCain Table 4-14 (Mao & Duan 2009).
...
_MD_D = [0, 2885310.0, -11072.577, -9.0834095, 0.030925651, -0.0000274071,
         -1928385.1, 5621.6046, 13.82725, -0.047609523, 0.000035545041]
_MD_A = [-0.21319213, 0.0013651589, -0.0000012191756]
_MD_B = [0.069161945, -0.00027292263, 0.0000002085244]
