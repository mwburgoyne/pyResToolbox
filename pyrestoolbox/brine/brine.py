...
def make_pvtw_table(*args, **kwargs):
    """Deprecated: Use simtools.make_pvtw_table() instead. This wrapper remains for backward compatibility."""
    from pyrestoolbox.simtools import make_pvtw_table as _make_pvtw_table
    return _make_pvtw_table(*args, **kwargs)
...
class SoreideWhitson:
    ...
    def _calc_properties(self, pBar):
        ...
        # ================================================================
        psia_p1 = (pBar + 1) * BAR2PSI
        bw_p1, den_p1_brine_sg, vis_p1_cP, _, _ = brine_props(
            p=psia_p1, degf=degf, wt=wt, ch4_sat=0
        )
        _, den_p1_fw_sg, _, _, _ = brine_props(
            p=psia_p1, degf=degf, wt=0, ch4_sat=0
        )
        ...
        # ================================================================
        # Reuse P+1 bar density from Step 5 (den_p1_brine_sg, den_p1_fw_sg already computed)
        Mpa_p1 = (pBar + 1) * 0.1
